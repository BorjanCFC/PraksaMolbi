...
exports.getDashboard =
  async (req, res) => {
    ...
    try {
      ...
      if (
        requiresArchiveNumberBeforeReview(
          user.role
        )
      ) {

        whereClause.arhivskiBroj = {
          [Op.not]:
            null
        };
      }
...
/* =========================================================
   ...
   - DO NOT change microsoft provider
   - DO NOT delete Student profile
   - add new relation in user_roles

   New user:
   - create feit_pop3 user
   - add selected role in user_roles
========================================================= */
...
exports.assignRoleByEmail =
  async (req, res) => {
    ...
    /* =====================================================
       ONLY ACTIVE ADMIN CAN ASSIGN ROLES
    ===================================================== */
    ...
    try {
      ...
      const result =
        await User.sequelize.transaction(
          async (
             ...
             * НЕ по provider.
             *
             * Ист email може да биде:
             *
             * provider = microsoft
             * roles = Student
             *
             * и сега да добие Admin.
             */
            let targetUser =
              await User.findOne({
                where: {
            ...
            if (targetUser) {
               ...
               * Microsoft студент:
               *
               * provider останува microsoft.
               * providerId останува.
               * password останува.
               * studentProfile останува.
               * Student role останува.
               *
               * Само authServer може да се ажурира,
               * за административниот FEIT login.
               */
              if (
                targetUser.provider !==
                'local'
            ...
            /*
             * Новиот user ја добива
             * избраната administrative role.
             */
            await UserRole.create(
              {
                userId:
      ...
      /*
       * Дополнителна заштита ако
       * поради race condition два request-а
       * пробаат да ја додадат истата role.
       */
      if (
        error &&
        error.name ===
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (
        ...
        req.flash(
          'error',
          'Учебната година не е валидна. Втората година мора да е следна (пример 2025/2026).'
        );
      ...
      /*
       * Student profile секогаш
       * ја чува последната вредност
       * за индекс и насока.
       */
      ...
      if (user.email) {
        ...
        console.log(
          '[Controller] Triggering email send for:',
          user.email
        );
        ...
        console.warn(
          '[Controller] User email not found for user:',
          user.userId
        );
      }
      ...
      if (
        ...
        req.flash(
          'error',
          'Бројот на индекс веќе постои. Внесете валиден и уникатен број на индекс.'
        );
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (
        ...
        req.flash(
          'error',
          'Оваа молба уште не е архивирана и не е достапна за обработка.'
        );
...
exports.generateArchivePdf =
  async (req, res) => {
    ...
    if (
      ...
      req.flash(
        'error',
        'Само студентската служба може да генерира PDF од молба.'
      );
    ...
    try {
      ...
      if (
        ...
        req.flash(
          'error',
          'PDF може да се генерира само за одобрена или одбиена молба.'
        );
      ...
      if (
        ...
        req.flash(
          'error',
          'Прво внесете архивски број, па потоа генерирајте PDF.'
        );
      ...
      if (
        ...
        req.flash(
          'error',
          'PDF за оваа молба е веќе генериран.'
        );
      ...
      req.flash(
        'success',
        'PDF документот е успешно генериран.'
      );
...
exports.generateMolbaPdf =
  async (req, res) => {
    ...
    if (
      ...
      req.flash(
        'error',
        'Само студентска служба може да генерира PDF на молба.'
      );
    ...
    try {
      ...
      if (
        ...
        try {
          ...
          console.warn(
            '[Controller] Error deleting old PDF:',
            unlinkError.message
          );
        }
      }
        ...
        if (
          ...
          sendMolbaApprovedEmail(
            ...
            (err) => {
              ...
              console.error(
                '[Controller] Background approval email error:',
                err.message
              );
            }
          );
          ...
          sendMolbaRejectedEmail(
            ...
            (err) => {
              ...
              console.error(
                '[Controller] Background rejection email error:',
                err.message
              );
            }
          );
      ...
      req.flash(
        'success',
        'PDF документот е успешно генериран и пратен на студентот.'
      );
...
exports.updateStatus =
  async (req, res) => {
    ...
    if (
      ...
      req.flash(
        'error',
        'Немате дозвола за промена на статус.'
      );
    ...
    try {
      ...
      if (
        ...
        req.flash(
          'error',
          'Молбата не може да се обработи пред да се внесе архивски број.'
        );
      ...
      req.flash(
        'success',
        'Успешно зачуван статус на молбата.'
      );
...
exports.updateArchiveNumber =
  async (req, res) => {
    ...
    if (
      ...
      req.flash(
        'error',
        'Само архивата може да внесе архивски број.'
      );
    ...
    try {
      ...
      if (
        ...
        req.flash(
          'error',
          'Архивскиот број мора да биде уникатен. Внесете друг број.'
        );
